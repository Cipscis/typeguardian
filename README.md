...
![Build and deploy status badge](https://github.com/cipscis/typeguardian/actions/workflows/build-and-deploy.yml/badge.svg)

[TypeGuardian](https://cipscis.github.io/typeguardian/)

## Development

You will need to install [Node.js](https://nodejs.org/en/) before working on this project.

1. Clone the repository using `git clone https://github.com/cipscis/typeguardian.git`.
